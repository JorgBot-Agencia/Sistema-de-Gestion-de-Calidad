...
<!-- Modal -->
<div class="modal fade" id="describe_resultado" tabindex="-1" role="dialog" aria-labelledby="describe_resultado">
<div class=" col-md-10 col-md-offset-1" role="document" style="margin-top: 50px">
<div class="modal-content" >
<div class="modal-header">
<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
<h4 class="modal-title text-center" id="myModalLabel">Descripcion de Resultado</h4>
</div>
<div class="modal-body">
<div class="row">
<div class="col-md-5" style="margin-top: 20px; text-align: right;"> <strong>Nombre del Indicador:</strong></div>
<div class="col-md-7" id="nombre_indicador"  style="margin-top: 20px"></div>

<div class="col-md-5"  style="margin-top: 20px; text-align: right;"><strong>Periodo:</strong></div>
<div class="col-md-7" id="periodo"  style="margin-top: 20px"></div>

<div class="col-md-5"  style="margin-top: 20px; text-align: right;"><strong>Ciudad:</strong></div>
<div class="col-md-7" id="ciudad"  style="margin-top: 20px"></div>

<div class="col-md-5"  style="margin-top: 20px; text-align: right;"><strong>Análisis:</strong></div>
<div class="col-md-7" id="analisis"  style="margin-top: 20px"></div>

<div class="col-md-5"  style="margin-top: 20px; text-align: right;"><strong>Resultado:</strong></div>
<div class="col-md-7" id="resultado"  style="margin-top: 20px"></div>
...
@section('script')
<script >
$("body").on("click", "table#mensuales tbody tr td, table#trimestrales tbody tr td", function(){
...
url:"{{ route('Indicadores_get_resultado')}}",
success: function(resp){
$("#nombre_indicador").empty();
$("#periodo").empty();
$("#ciudad").empty();
$("#analisis").empty();
$("#resultado").empty();
...
var detalle = resp["resultados"];
var detalle_resultado =detalle[0];
$("#nombre_indicador").text(detalle_resultado["indicadore"]["indicador"])
$("#periodo").text(detalle_resultado["periocidad"])
$("#ciudad").text(detalle_resultado["ciudad"])
$("#analisis").text(detalle_resultado["analisis"])
$("#resultado").text(detalle_resultado["resultado"])

$("#describe_resultado").modal();
...
if(desc_indicadore["frecuencia"]==="TRIMESTRAL" && indicadore_selec["periocidad"] !=="Enero" && indicadore_selec["periocidad"] !=="Febrero" && indicadore_selec["periocidad"] !=="Marzo" && indicadore_selec["periocidad"] !=="Abril" && indicadore_selec["periocidad"] !=="Junio" && indicadore_selec["periocidad"] !=="Julio" && indicadore_selec["periocidad"] !=="Agosto" && indicadore_selec["periocidad"] !=="Septiembre" && indicadore_selec["periocidad"] !=="Octubre" && indicadore_selec["periocidad"] !=="Noviembre" && indicadore_selec["periocidad"] !=="Diciembre")  
{
...
if(desc_indicadore["frecuencia"]==="MENSUAL" && indicadore_selec["periocidad"] !=="Enero - Marzo" && indicadore_selec["periocidad"] !=="Abril - Junio" && indicadore_selec["periocidad"] !=="Julio - Septiembre"  && indicadore_selec["periocidad"] !=="Octubre - Diciembre")
{ 
...
{
//alert(fila_correspondiente_tri +"--"+indicadore_selec["periocidad_id"]+"--"+indicadore_selec["resultado"])
$("table#trimestrales tr#trimestre_"+indicadore_selec["periocidad_id"]+" td:nth-child("+fila_correspondiente_tri+")").text(indicadore_selec["resultado"]).attr("id",indicadore_selec["id"])
...
{
//alert(fila_correspondiente_tri +"--"+indicadore_selec["periocidad_id"]+"--"+indicadore_selec["resultado"])
$("table#mensuales tr#trimestre_"+indicadore_selec["periocidad_id"]+" td:nth-child("+fila_correspondiente_tri+")").text(indicadore_selec["resultado"]).attr("id",indicadore_selec["id"])
